...
- [docs/OPEN_ITEMS.md](docs/OPEN_ITEMS.md)：保留未收口事项
- [docs/WORK_INDEX.md](docs/WORK_INDEX.md)：整理顺序索引
- [docs/CURRENT_CHANGESET_INDEX.md](docs/CURRENT_CHANGESET_INDEX.md)：当前变更面的最终收尾索引
...
- [docs/OPENHARNESS_BRIDGE_OPEN_ITEMS.md](docs/OPENHARNESS_BRIDGE_OPEN_ITEMS.md)
