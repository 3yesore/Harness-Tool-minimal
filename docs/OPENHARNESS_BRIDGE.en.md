...
## Position
`harness_tool` stays the upstream contract and project-structure provider.
`OpenHarness` stays an external agent runtime and orchestration system.
...
- `docs/OPENHARNESS_BRIDGE_OPEN_ITEMS.en.md`
- `docs/OPENHARNESS_BRIDGE_INDEX.en.md`
