...
This folder collects supporting docs and release materials. The repository root keeps only the main entry points and core spec files.
...
- Read the root spec pages first, then use this hub for topic-specific materials
