...
## Purpose
This index groups the current working changes by responsibility so final cleanup
can happen without mixing `core`, bridge, and support files.

## Core / Contract Path
These files still belong to the main `harness_tool` contract path:
