...
- `UPGRADE_CHECKLIST.en.md`

## Notes

- This package is a release preparation bundle for the beta publication.
- It mirrors the current repository state and the release-facing wording.
